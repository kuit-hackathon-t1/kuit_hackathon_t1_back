...
public record CreateCollectionResponse(
        Long collectionId, Long missionId, MissionStatus missionStatus, LocalDateTime createdAt) {

    public static CreateCollectionResponse from(Collection collection) {
        return new CreateCollectionResponse(
                collection.getCollectionId(),
                collection.getMission().getMissionId(),
                collection.getMission().getMissionStatus(),

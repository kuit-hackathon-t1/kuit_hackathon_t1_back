...
public record CollectionListResponse(Long tripId, List<CollectionItem> collections) {
    ...
    public static CollectionListResponse of(Long tripId, List<Collection> collections) {
        return new CollectionListResponse(tripId, collections.stream().map(CollectionItem::from).toList());
    }
    ...
    public record CollectionItem(
        ...
        public static CollectionItem from(Collection collection) {
            return new CollectionItem(collection.getCollectionId(), collection.getLocalImageId(),
                    collection.getMission().getTitle(), collection.getCropType(), collection.getStatus(),
